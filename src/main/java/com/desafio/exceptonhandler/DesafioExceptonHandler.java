package com.desafio.exceptonhandler;
...
@ControllerAdvice
public class DesafioExceptonHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleEmptyResultDataAccessException(EmptyResultDataAccessException ex, WebRequest request) {
		String menssagemUsuario = messageSource.getMessage("dado.nao-encontrado", null, LocaleContextHolder.getLocale());
